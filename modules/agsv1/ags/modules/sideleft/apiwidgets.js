...
import { WallpaperView, wallpaperCommands, sendMessage as wallpaperSendMessage, wallpaperTabIcon } from './apis/wallpaper.js';
...
const APILIST = {
    ...
    'wallpaper': {
        ...
        "contentWidget": WallpaperView(chatEntry),
        "commandBar": wallpaperCommands,
        "tabIcon": wallpaperTabIcon,
        "placeholderText": getString('Wallpaper commands...'),
    },
}
